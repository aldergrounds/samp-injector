...
- **Error Message Titles**
   - `ERROR_TITLE_SAMP`: Стандартный заголовок для диалоговых окон ошибок, связанных со сбоями SA-MP (`"SA-MP Injector Error"`).
   - `ERROR_TITLE_OMP`: Стандартный заголовок для диалоговых окон ошибок, связанных со сбоями OMP (`"OMP Injector Error"`).
